    ...
    var r = (function () {
            function e(i, s, r) {
                t(this, e),
                    ...
                    (this.ready_ = !1);
                var n = r || {};
                (this.zIndex_ = n.zIndex || google.maps.Marker.MAX_ZINDEX + 1),
                    ...
                    (this.imageExtension_ =
                        n.imageExtension || this.MARKER_CLUSTER_IMAGE_EXTENSION_),
                    (this.zoomOnClick_ = !0),
                    n.zoomOnClick != null && (this.zoomOnClick_ = n.zoomOnClick),
                    (this.averageCenter_ = !1),
                    n.averageCenter != null && (this.averageCenter_ = n.averageCenter),
                    this.setupStyles_(),
                    this.setMap(i),
                ...
                google.maps.event.addListener(this.map_, "zoom_changed", function () {
                    var e = a.map_.getZoom(),
                        ...
                        i = Math.min(
                            a.map_.maxZoom || 100,
                            a.map_.mapTypes[a.map_.getMapTypeId()].maxZoom
                        );
            ...
            return (
                s(e, [
                    ...
                    },
                    {
                        key: "calculator_",
                        value: function (e, t) {
                            for (var i = 0, s = e.length, r = s; r !== 0; )
                    ...
                    },
                    {
                        ...
                        value: function (e) {
                            ...
                            return (
                                t != -1 &&
                                (e.setMap(null), this.markers_.splice(t, 1), !0)
                            );
                        },
                    },
                    {
                        ...
                        value: function (e, t) {
                            ...
                            return (
                                !(t || !i) && (this.resetViewport(), this.redraw(), !0)
                            );
                        },
                    },
                    {
                            ...
                            var i = ((t.lat() - e.lat()) * Math.PI) / 180,
                                ...
                                r =
                                    ...
                                    Math.cos((e.lat() * Math.PI) / 180) *
                                        ...
                                        Math.sin(s / 2);
                            return (
                                6371 * (2 * Math.atan2(Math.sqrt(r), Math.sqrt(1 - r)))
                            );
                        },
                    },
                    {
                        ...
                        value: function (e) {
                            for (
                                var t, i = 4e4, s = null, r = 0;
                                (t = this.clusters_[r]);
                                r++
                            ) {
                                var a = t.getCenter();
                                if (a) {
                                    var o = this.distanceBetweenPoints_(
                                        a,
                                        e.getPosition()
                                    );
                                    o < i && ((i = o), (s = t));
                            ...
                            if (s && s.isMarkerInClusterBounds(e)) s.addMarker(e);
                            else {
                                var h = new n(this);
                                h.addMarker(e), this.clusters_.push(h);
                            }
                        },
                    },
                    {
        ...
        n = (function () {
            function e(i) {
                t(this, e),
                    ...
                    (this.map_ = i.getMap()),
                    (this.gridSize_ = i.getGridSize()),
                    (this.minClusterSize_ = i.getMinClusterSize()),
                    (this.averageCenter_ = i.isAverageCenter()),
                    (this.center_ = null),
                    (this.markers_ = []),
                    (this.bounds_ = null),
                    (this.clusterIcon_ = new a(this, i.getStyles(), i.getGridSize()));
            }
            return (
                s(e, [
                    {
                    ...
                    },
                    {
                        ...
                        value: function (e) {
                            ...
                            if (this.center_) {
                                if (this.averageCenter_) {
                                    var t = this.markers_.length + 1,
                                        i =
                                            (this.center_.lat() * (t - 1) +
                                                e.getPosition().lat()) /
                                            t,
                                        s =
                                            (this.center_.lng() * (t - 1) +
                                                e.getPosition().lng()) /
                                            t;
                            ...
                            return (
                                r >= this.minClusterSize_ && e.setMap(null),
                                this.updateIcon(),
                                !0
                            );
                        },
                        ...
                        value: function () {
                            ...
                            if (t && e > t)
                                ...
                                var r = this.markerClusterer_.getStyles().length,
                                    n = this.markerClusterer_.getCalculator()(
                                        this.markers_,
                                        r
                                    );
                ...
                s(i, [
                        ...
                        value: function () {
                            ...
                            google.maps.event.trigger(
                                ...
                                t.isZoomOnClick() &&
                                    ...
                                    this.map_.setCenter(e.getCenter()));
                        },
                    },
                    {
                        key: "onAdd",
                    ...
                    },
                    {
                        ...
                        value: function (t) {
                            ...
                            i.push(
                                "z-index:" +
                                    this.cluster_.markerClusterer_.getZIndex() +
                                    ";"
                            ),
                                i.push("background-image:url(" + this.url_ + ");");
                            var s = this.backgroundPosition_
                                ? this.backgroundPosition_
                                : "0 0";
                            i.push("background-position:" + s + ";"),
                                e(this.anchor_) === "object"
