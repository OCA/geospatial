    ...
    var MapRenderer = BasicRenderer.extend({
        ...
        _getMapTheme: function () {
            ...
            var update_map = function (style) {
                var styledMapType = new google.maps.StyledMapType( // eslint-disable-line
        ...
        _createMarker: function (latLng, record, color) {
            ...
            if (fieldMarkerColor) {
                options.icon = {
                    path:
                        "M583 1885 c-82 -22 -147 -60 -216 -125 -103 -96 -157 -220 -157 -360 0 -135 33 -211 216 -496 57 -89 128 -211 158 -271 53 -105 135 -326 137 -368 0 -11 11 18 24 65 51 186 140 366 305 615 147 223 197 353 187 486 -17 221 -166 397 -384 454 -71 19 -201 18 -270 0z m210 -309 c71 -29 126 -127 113 -199 -13 -71 -82 -140 -153 -153 -78 -15 -178 46 -204 124 -48 144 104 287 244 228z",
        ...
        _renderMarkers: function () {
            var isGrouped = Boolean(this.state.groupedBy.length);
            if (isGrouped) {
                this._renderGrouped();
            } else {
            ...
            _.each(this.state.data, function (record) {
                ...
                _.each(record.data, function (rec) {
                    latLng = new google.maps.LatLng(
                        rec.data[self.fieldLat],
                        rec.data[self.fieldLng]
                    );
