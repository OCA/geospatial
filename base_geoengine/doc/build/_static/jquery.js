...
(function (A, w) {
    ...
    c.fn = c.prototype = {
        ...
        eq: function (a) {
            return a === -1 ? this.slice(a) : this.slice(a, Number(a) + 1);
        },
        first: function () {
            return this.eq(0);
        },
    ...
    (function () {
        ...
        if (!(!e || !e.length || !j)) {
            c.support = {
                ...
                htmlSerialize: Boolean(d.getElementsByTagName("link").length),
                style: /red/.test(j.getAttribute("style")),
                hrefNormalized: j.getAttribute("href") === "/a",
                opacity: /^0.55$/.test(j.style.opacity),
                cssFloat: Boolean(j.style.cssFloat),
        ...
        attr: function (a, b, d, f) {
            ...
            if (a.nodeType === 1) {
                ...
                if (!c.support.style && f && b === "style") {
                    if (e) a.style.cssText = String(d);
                    return a.style.cssText;
                }
                e && a.setAttribute(b, String(d));
                a =
    ...
    (function () {
        ...
        var n = (k.selectors = {
                ...
                filters: {
                    ...
                    parent: function (g) {
                        return Boolean(g.firstChild);
                    },
                    empty: function (g) {
                        return !g.firstChild;
                    },
                    has: function (g, h, l) {
                        return Boolean(k(l[3], g).length);
                    },
                    header: function (g) {
                    ...
                    button: function (g) {
                        return (
                            g.type === "button" || g.nodeName.toLowerCase() === "button"
                        );
                    },
                    input: function (g) {
                ...
                filter: {
                    PSEUDO: function (g, h, l, m) {
                        ...
                        if (p) return p(g, l, h, m);
                            ...
                            return (
                                (g.textContent || g.innerText || a([g]) || "").indexOf(
                                    h[3]
                                ) >= 0
                            );
                        else if (q === "not") {
        ...
        var E = s.compareDocumentPosition
                ? function (g, h) {
                      return Boolean(g.compareDocumentPosition(h) & 16);
                  }
                : function (g, h) {
    ...
    c.fn.extend({
        ...
        is: function (a) {
            return Boolean(a) && c.filter(a, this).length > 0;
        },
            ...
            if (d)
                for (j = 0; e[j]; j++)
                    if (
                        ...
                        f.push(
                            e[j].parentNode ? e[j].parentNode.removeChild(e[j]) : e[j]
                        );
                    else {
                        e[j].nodeType === 1 &&
                            e.splice.apply(
        ...
        style: function (a, b, d) {
            ...
            if (!c.support.opacity && b === "opacity") {
                ...
                return f.filter && f.filter.indexOf("opacity=") >= 0
                    ? String(parseFloat(Oa.exec(f.filter)[1]) / 100)
                    : "";
            }
            if (ha.test(b)) b = Pa;
            b = b.replace(ia, ja);
                    ...
                    f !== "border" &&
                        c.each(j, function () {
                            ...
                            if (f === "margin")
                                ...
                                e -=
                                    parseFloat(
                                        c.curCSS(a, "border" + this + "Width", true)
                                    ) || 0;
                        });
                }
    ...
    c.extend({
        ...
        ajax: function (a) {
            ...
            if (x) {
                ...
                try {
                    x.send(
                        n === "POST" || n === "PUT" || n === "DELETE" ? e.data : null
                    );
                } catch (m) {
